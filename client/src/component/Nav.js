        ...
        return (
            <>
                <nav className="navbar-container">
                    ...
                    <div id="navbar-mobile-menu"><img src="../icons/menu.png" className="menu-icon"
                                                      onClick={this.showMobileNavBar}/></div>
                    <ul className="navbar">
                        <li><NavLink to="/" className={({isActive}) => isActive ? "active" : "inactive"}>HOME</NavLink>
                        </li>
                        <li><NavLink to="/products"
                                     className={({isActive}) => isActive ? "active" : "inactive"}>PRODUCTS</NavLink>
                        </li>
                        <li><NavLink to="/about"
                                     className={({isActive}) => isActive ? "active" : "inactive"}>ABOUT</NavLink></li>
                    </ul>
                    <div className="logo-mobile"><b>GUITAR HERO</b></div>
                    <Link to={"/login"} style={{display: this.state.isRegistered ? "none" : "flex"}}
                          id="signup-button-link">
                    ...
                    <div id="icons-container" style={{display: this.state.isRegistered ? "flex" : "none"}}>
                        <div id="user-container">
                            ...
                            <div id="dropdown" style={{display: this.state.isMenuActive ? "flex" : "none"}}>
                                ...
                                <hr/>
                                <div className="dropdown-option" style={{color: "#db3d45"}} onClick={this.handleLogOut}>
                                    <b>LOG OUT</b></div>
                            </div>
                        </div>
                ...
                <ul className="navbar-mobile">
                    ...
                    <li><NavLink to="/products"
                                 className={({isActive}) => isActive ? "active" : "inactive"}>PRODUCTS</NavLink></li>
                    <li><NavLink to="/about"
                                 className={({isActive}) => isActive ? "active" : "inactive"}>ABOUT</NavLink></li>
                </ul>
            </>
