            ...
            <div className="login-bg">
                ...
                <div id="login-form-container"><Link to="/"><p id="login-back">&#8592; BACK</p></Link>
                    <div id="login-container">
                        ...
                        <form id="login" onSubmit={this.handleSubmit}>
                            <>
                                <div className="login-cred-container">
                                    ...
                                    <input type="text" id="login-email" name="email" onChange={this.handleChange}
                        ...
                        <div id="register-text-container"><p id="register-text">Don't have an account yet? <Link
                            id="register-link" to="/register">Register</Link></p></div>
                    </div>
                </div>
            </div>
        )
